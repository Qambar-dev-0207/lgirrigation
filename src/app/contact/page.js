        ...
        <div className="container">
          ...
          <div className="contact-grid">
            ...
            <div className="contact-info-block">
              ...
              <div className="info-item">
                <div className="info-icon">
                  <svg viewBox="0 0 24 24" style={{ width: "20px", height: "20px", fill: "var(--ink-black)" }}><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </div>
                <div className="info-text">
                  <h4>LinkedIn Network</h4>
                  <p style={{ marginBottom: 0 }}><a href="https://www.linkedin.com/posts/lg-irrigatio9_lgirrigation-hdpepipes-irrigation-activity-7493360698597675008-xZCp?utm_source=share&utm_medium=member_android&rcm=ACoAAGrZCOQB4pfga5t2YKl4wmc8w3i6rVR8gPE" target="_blank" rel="noopener noreferrer">L G Irrigation on LinkedIn</a></p>
                </div>
              </div>
